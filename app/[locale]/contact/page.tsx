            ...
            <div className="md:col-span-2 space-y-6">
              <div className="space-y-5">
                <a
                  ...
                  className="focus-ring flex items-center gap-4 p-4 rounded-xl bg-surface-low border border-transparent hover:border-brand/15 hover:-translate-y-0.5 transition-all duration-300 group"
                >
